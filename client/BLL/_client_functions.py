...
class Client(object):
    def __init__(self,
                 ...
                 seq_bits=16,
                 window_size=1,
                 client_data_folder=os.path.join(os.getcwd(), "Client/downloads"),file_name="",timeout=10,count=None):
        print(client_data_folder)
    ...
    def run(self):
        ...
        while self.runThread:
            ...
            if not ready[0]:
                ...
                print(self.count.download_file_count_pack)
...
def create_packet(ack:PacketHandler):
