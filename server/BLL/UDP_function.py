...
class Server(object):
    def __init__(self,
                 ...
                 server_data_folder=os.path.join(os.getcwd(), "/Server/files")):
        ...
        self.thread=threading.Thread(target=self.open)
    ...
    def get_count_packet(self,
        ...
        packet_handler = PacketHandler(file_name,
                                       ...
                                       total_packets,
                                       timeout)
        s=packet_handler.generate_packets()
        return len(s)
...
class PacketHandler(Thread):
    ...
    def generate_packets(self):
        ...
        packets:list[PacketHandler.PACKET] = []
        i=0
